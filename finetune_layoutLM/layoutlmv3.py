...
class DatasetConfig(datasets.BuilderConfig):
    """BuilderConfig for PaperImageExtraction Dataset"""
...
class PaperImageExtraction(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        DatasetConfig(name="PaperImageExtraction", version=datasets.Version("1.0.0"), description="PaperImageExtraction dataset"),
    ]
    ...
    def _split_generators(self, dl_manager):
        ...
        dest = os.path.join(data_path, 'data', 'dataset')
